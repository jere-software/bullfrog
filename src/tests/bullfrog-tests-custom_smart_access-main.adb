...
package body Bullfrog.Tests.Custom_Smart_Access.Main is
   procedure Run is
      ...
      ttw1 : aliased TT.Weak_Access   := TT_Make.Weak_Access(tts1);
      ttu1 : aliased TT.Unique_Access := TT_Make.Unique_Access(Make_Test_Type);
      ttu2 : aliased TT.Unique_Access := TT_Make.Unique_Access(Make_Test_Type);
      ttu3 : aliased TT.Unique_Access := TT_Make.Unique_Access(Make_Test_Type);
      ttu4 : aliased TT.Unique_Access := TT_Make.Unique_Access(Make_Test_Type);

      tts2 : aliased TT.Shared_Access := tts1;
      tts3 : aliased TT.Shared_Access := TT_Make.Shared_Access(ttw1);
      tts4 : aliased TT.Shared_Access := TT_Make.Shared_Access(ttu1);
      ...
      ttu5 : aliased TT.Unique_Access := TT_Make.Unique_Access(ttu2);
